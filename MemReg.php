                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        <span class="user-name">Supriyak Thama<i class="fa fa-angle-down"></i></span>
        ...
        <?php 
            ...
            if(isset($_POST['addmember'])){
                ...
                // else{  
                    ...
                    $memreg = "INSERT INTO `member_rej` ( `fname`, `lname`, `age`, `contactNo`, `address`, `reg_date`, `weight`, `height`,`bmi`, `special_notes`) 
                                        VALUES ('$fname','$lname','$age','$contactNo','$address','$reg_date','$weight','$height','$bmi','$specialn')";
